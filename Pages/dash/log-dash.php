    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            <ul>
                ...
                <li><a href="log-dash.php" class="active">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#insert', function() {
                var time = $('#data1').text();
                var pr_id = $('#data2').text();
                var action = $('#data3').text();
                if (time != '' && pr_id != '' && action != '') {
                    $.ajax({
                        url: "dash-log/insert.php",
                        method: "POST",
                        data: {
                            time: time,
                            pr_id: pr_id,
